...
import { Plus, History, Palette, Zap } from "lucide-react"
    ...
    <div className="space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white">
          Welcome to Inked, {user?.user_metadata?.full_name || "Creator"}!
        </h1>
        <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
          Generate stunning custom stickers with AI and order them in bulk. Turn your ideas into reality with just a few
          clicks.
        </p>
      </div>
        ...
        <Card className="hover:shadow-lg transition-shadow bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
          <CardHeader>
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Use AI to generate custom sticker designs from your prompts and images
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="bg-gradient-to-r from-slate-50 via-blue-50 to-slate-100 dark:from-slate-900/50 dark:via-blue-950/50 dark:to-slate-800/50 rounded-lg p-8 text-center space-y-4 border border-slate-200 dark:border-slate-800">
        ...
        <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Powered by AI</h2>
        <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
          Our advanced AI technology transforms your creative ideas into professional-quality sticker designs. Simply
          describe what you want, upload reference images, and let our AI do the magic.
        </p>
      </div>
    </div>
  )
